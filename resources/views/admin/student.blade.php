        ...
        <table class="table table-sm border" id="studenttable">
            ...
            <tbody id="studenttbody">
                ...
                <tr>
                    ...
                    @if ($d->active == 1)
                    <td>Active</td> 
                <td><a class="btn btn-danger text-white" href='studentdisable/{{$d->user_id}}'>Disable</a></td>
                    @else
                    <td>Disabled</td> 
                <td><a class="btn btn-success text-white" href='studentenable/{{$d->user_id}}'>Enable</a></td>
                    @endif
                </tr>
                @endforeach
            </tbody>
